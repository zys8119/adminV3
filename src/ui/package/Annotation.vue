<template>
    <div class="Annotation">
        ...
        <el-popover
                ...
                v-model="visible">
            <div slot="reference" class="popoverBtn" :style="popoverStyles"></div>
            <slot name="mark" :vm="_self">
        ...
        <el-popover
                ...
                v-model="visibleClickShow">
            <div slot="reference" class="popoverBtn" :style="popoverStyles"></div>
            <slot name="display" :vm="_self" :data="displayData">
                <div class="content-btn">
        ...
        {{$slots.default | slotswatchFilter(_self)}}
    </div>
</template>
    ...
    export default {
        ...
        data(){
            return {
                ...
                btnList: [
                    {name: '复制', img: './images/Annotation/1.png', type: 'copy'},
                    {name: '划线', img: './images/Annotation/2.png', type: 'line'},
                    {name: '高亮', img: './images/Annotation/3.png', type: 'notes'},
                    {name: '搜索', img: './images/Annotation/4.png', type: 'search'},
                ],
                btnDelList: [
                    {name: '删除标记', img: './images/Annotation/1.png', type: 'delete'},
                    {name: '搜索', img: './images/Annotation/4.png', type: 'search'},
                ],
                popoverStyles:{},
                selection:{},
        ...
        filters:{
            slotswatchFilter(v,_this){
                _this.$nextTick(()=>{
                    let all_el = _this.$el.querySelectorAll(".AnnotationContent *");
                    let dataKey_el = _this.$el.querySelectorAll(".AnnotationContent *[data-key]");
