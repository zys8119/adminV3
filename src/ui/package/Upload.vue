<template>
    <div class="ZUpload">
        ...
        <el-dialog :title="mediaShowTitle" :visible.sync="mediaShow" append-to-body class="t-a-c">
        ...
        <!--    检测结果表格    -->
        <el-dialog title="敏感词检测" :visible.sync="testingResult" append-to-body :close-on-click-modal="false">
